...
function BUSD() {
  ...
  useEffect(() => {
    if (address !== "") {
      dispatch(Liquidity.getUserInfoDetails(2, address));
      dispatch(Liquidity.getPoolInfo(2));
    }
  }, [address]);
          ...
          if (parseFloat(_enteredValue) > parseFloat(_allowance)) {
            ...
            if (_approve) {
              ...
              let _addLiquidity = await StakingInstance.methods
                .addLiquidityToken(2, _enteredValue)
                .send({ from: address, value: 0 });

              if (_addLiquidity) {
                Error.toastifyMsg("info", "Liquidity Added Sucessfully");
                await dispatch(Liquidity.getUserInfoDetails(2, address));
                await dispatch(Liquidity.getPoolInfo(2));
    ...
    try {
      ...
      if (uid == undefined || uid == null) {
        ...
        let _wLiquidity = await StakingInstance.methods
          .withdrawLiquidity(2, uid) //hardcoded uId ,, fix in prod
          .send({ from: address });
          ...
          >
            ...
            <div className="col-md-3">
              <div className="aligncenter">
                <img src={busdLogo} className="inner-img" />
              </div>
            </div>
            <div
              id="contentBody"
            ...
            >
              <div id="contentText" className="ct__fs24">
                Provide liquidity in BUSD/PXA @50% off
              </div>
            </div>
          </div>
            ...
            <div className="row">
                  ...
                  <Table responsive className="per70Card__addLiq">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="earn__tableCellValue">
                          {parseFloat(poolInfo.maxDeposit).toFixed(3)} BUSD
                        </td>
                      </tr>
                      <tr>
              ...
              <div>
                ...
                <InputGroup className="col-md-12">
                  <FormControl
                    placeholder="Enter amount of BUSD"
